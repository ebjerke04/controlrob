...
class CommandXArm(Node): 
    def __init__(self): 
        ...
        #new defined gripper angle
        self.gripper_angle = 0.0

        self.sub_gripper_angle = self.create_subscription(Float64, '/gripper_angle_desired', self.update_gripper_angle, 1)
    ...
    def update_gripper_angle(self, msg_in):
        self.gripper_angle = float(msg_in.data)
    ...
    def compute_commands(self, msg_in): 
        ...
        #override servo angle which is jt_all[6]
        jt_all[6] = self.gripper_angle
